  ...
  <body>
    ...
    <div class="compose-form-wrapper">
      <form action="sendpost.php" method="post">
         ...
         <span class="req">*</span>
         <span>Content <img onclick="window.location.href='https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet'" title="Styling with markdown is supported" class="md hoverpointer" src="../assets/md.png" /></span><br />
